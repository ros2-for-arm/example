...
#ifndef TA_SECURITY_API__TA_AES_H_
#define TA_SECURITY_API__TA_AES_H_
...
#define TA_AES_IS_KEY_SIZE_SUPPORTED(keysize) (TA_AES128_SIZE == (keysize))
...
#endif  // TA_SECURITY_API__TA_AES_H_
