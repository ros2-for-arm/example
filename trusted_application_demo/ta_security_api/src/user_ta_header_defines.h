...
/*
 *   This file is called by the make file TA_DEV_KIT_DIR/mk/ta_dev_kit.mk
 *   It is expected to be in the same directory of the makefile
 *   The name and path to this file cannot be changed
 */
#ifndef TA_SECURITY_API__USER_TA_HEADER_DEFINES_H_
#define TA_SECURITY_API__USER_TA_HEADER_DEFINES_H_

#include <ta_public.h>

#define STR_TRACE_USER_TA "Trusted Application"

/* Used for updating the ta_head structure in
...
#endif // TA_SECURITY_API__USER_TA_HEADER_DEFINES_H_
